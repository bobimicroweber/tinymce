import { AutocompleterEventArgs, AutocompleterUpdateActiveRangeEventArgs } from '../autocomplete/AutocompleteTypes';
...
const fireAutocompleterUpdateActiveRange = (editor: Editor, args: AutocompleterUpdateActiveRangeEventArgs): void => {
